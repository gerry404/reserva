<script setup>
/**
 * Les logos de marque, que Lucide ne fournit pas.
 *
...
const props = defineProps({
  name: {
    type: String,
    required: true,
    validator: (v) => ['whatsapp', 'google', 'facebook', 'instagram', 'x'].includes(v),
  },
  /** Libellé lu par les lecteurs d'écran. Absent : l'icône est décorative. */
...
/** Les quatre couleurs officielles de Google, dans l'ordre de tracé. */
const google = [
...
<template>
  ...
  >
    ...
    <template v-if="name === 'google'">
      <path v-for="p in google" :key="p.fill" :d="p.d" :fill="p.fill" />
    </template>
